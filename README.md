...
Example Node.js Chat APP based on Socket.io! The UI is currently not responsive and well designed because this project should only show the socket.io relevant parts.
